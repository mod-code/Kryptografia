...
class RSA:
    def __init__(self, p, q):
        ...
        self.character_dict = {
            ...
            '1': 65, '2': 66, '3': 67, '4': 68, '5': 69, '6': 70, '7': 71, '8': 72, '9': 73,
            '0': 74, 'ą': 75, 'Ą': 76, 'ć': 77, 'Ć': 78, 'ę': 79, 'Ę': 81, 'ł': 82, 'Ł': 83,
            'ń': 84, 'Ń': 85, 'ó': 86, 'Ó': 87, 'ś': 88, 'Ś': 89, 'ż': 90, 'ź': 91, 'Ż': 92,
            'Ź': 93, ',': 94, '?': 95, '!': 96, ':': 97, '(': 98, ')': 99
        }
